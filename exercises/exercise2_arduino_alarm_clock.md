...
The second exercise took place on the 7th May 2026 and introduced us to the basics of Arduino. The goal was to gradually build a working alarm clock (see image below) by adding several sub-circuits with different features. By the end, we could further customize it by adding more features to it. For this exercise I was working together with Dena Boveirimonji. The images for this exercise can be found in the folder ex02_images, while the videos are uploaded in the video folder.  
