...
The last exercise took place on the 25th June 2026 and was about 3D printing. The images for this exercise are in the ex08_images folder, and the 3D model and slicing information are in the files folder. The goal of this exercise was to create a practical 3D model in Onshape and print it. On the 02nd July we could view our printed results.
