...
After I removed the supports with a plier, the holder was immediately put to use at home. While I was inserting the kitchen paper roll, I noticed that the middle pole was a bit too short (see images below). When I was creating the model, I naively thought that 21cm would be enough so I didn't do the extra step of measuring a paper towel's height. It turns out, 3 to 4 additional centimeters would have been perfect for the pole to stick out of the hole so the holder could be grabbed and moved more easily, but I think the whole structure would have become to tall for the 3D printer to print properly if I added a few more centimeters to the model. Maybe next time I can create a separate part that can be manually put on top of the pole as a solution, like it was done in the [paper towel holder example](https://www.printables.com/model/527747-geometrical-paper-towel-holder-v2-updated). Still overall I like the result!
